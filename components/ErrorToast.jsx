...
export default function ErrorToast({ dismiss, children }) {
  return (
    <div
      id="toast-danger"
      className="flex items-center p-4 mb-4 w-full max-w-xs text-gray-500 bg-white rounded-lg shadow dark:text-gray-400"
      role="alert"
    >
